...
function SplitButtonMenu({
  ...
  const { variant, size, disabled } = React.useContext(SplitButtonContext)
...
const SplitButtonMenuSeparator = React.forwardRef<
...
const SplitButtonMenuLabel = React.forwardRef<
